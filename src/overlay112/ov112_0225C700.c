	...
	for (v0 = 0; v0 < 4; v0++) {
        ...
        for (v5 = 0; v5 < v3; v5++) {
            ...
            case 0:
                ...
                break;
            case 1:
                v6 = Unk_ov112_0225D880[v0].unk_07 - (sub_02002EB4(0, v4, 0) + 1) / 2;
                break;
            case 2:
                v6 = Unk_ov112_0225D880[v0].unk_07 - sub_02002EB4(0, v4, 0);
                break;
            }
            sub_0201D78C(&param0->unk_00[v0], 0, v4, v6, v7, 0xFF, Unk_ov112_0225D880[v0].unk_0C, NULL);
            v7 += 16;
        }
        Strbuf_Free(v4);
