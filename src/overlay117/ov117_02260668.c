...
static void ov117_0226168C (UnkStruct_ov117_02261280 *param0, NARC *param1)
{
    ...
    sub_0200CDC4(param0->unk_8C, 2, param0->unk_24, param0->unk_28, param1, 27, 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 10003);

    v1 = MessageLoader_GetNewStrbuf(param0->unk_80, 2);
    v0 = 6 + ((30 - sub_02002D7C(0, v1, 0)) / 2);
    ...
    sub_0200CDC4(param0->unk_8C, 2, param0->unk_24, param0->unk_28, param1, 27, 0, 1, NNS_G2D_VRAM_TYPE_2DMAIN, 10004);
    sub_0200CC3C(param0->unk_24, param0->unk_28, param1, 24, 0, NNS_G2D_VRAM_TYPE_2DMAIN, 10002);
    sub_0200CE24(param0->unk_24, param0->unk_28, param1, 26, 0, 10002);
    sub_0200CE54(param0->unk_24, param0->unk_28, param1, 25, 0, 10002);
