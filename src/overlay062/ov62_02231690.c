...
static void ov62_02231C78(UnkStruct_ov62_022323B8 *param0, UnkStruct_0208C06C *param1) {
...

    {
...

        {
            ...
            sub_0200C2E0(v9, 0, v12);
            sub_0200C388(v9, v8, v6);
...

            {
                ...
                if (v13 == 0) {
                    ...
                    if (v14 != 0) {
                        ...
                        sub_0200BE08(v9, 0, v13, v14);
                        sub_0200C388(v9, v8, v6);

                        sub_0201D78C(v10, 0, v8, 4, 0, (0xff), (((u32)(((15 & (0xff)) << 16) | ((13 & (0xff)) << 8) | ((0 & (0xff)) << 0)))), NULL);
                        sub_0201A9A4(v10);
                        Strbuf_Free(v8);
                        Strbuf_Free(v6);
                    }
...
void ov62_02232778(UnkStruct_ov62_02233310 *param0, UnkStruct_0208C06C *param1, MessageLoader *param2, const UnkStruct_ov62_02248CDC *param3, int param4, int param5, Strbuf *param6) {
    ...
    for (v0 = 0; v0 < param0->unk_10; v0++) {
        ...
        if (param0->unk_28->unk_08 == 2) {
           if (param6) {
                sub_0200B48C(v7, 2, v11, 0, 1, 2);
                sub_0200C388(v7, v6, param6);
                sub_0201D78C(v1, 0, v6, 16, (v0 * (16 * param0->unk_28->unk_08)) + 16, (0xff), ((u32)(((15 & (0xff)) << 16) | ((13 & (0xff)) << 8) | ((0 & (0xff)) << 0))), NULL);
...
static void ov62_02234000 (UnkStruct_ov62_02233F74 * param0, UnkStruct_0208C06C * param1)
{
    ...
    int v8[12];
    int v9;
    UnkStruct_0200C6E4 * v10;
    UnkStruct_0200C704 * v11;
    PaletteSys * v12;
    s16 v13[][12][2] = {
        {
            {11 * 8, 13 * 8},
