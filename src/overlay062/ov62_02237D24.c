...
static void ov62_02239724(UnkStruct_0208C06C *param0) {
    ...
    sub_0200B48C(v4, 0, v1, 0, 1, 2);
    sub_0200BE48(v4, 1, v6);
    sub_0200C388(v4, v3, v2);

    v7 = Strbuf_NumLines(v3);
    for (v8 = 0; v8 < v7; v8++) {
        Strbuf_CopyLineNum(v1, v3, v8);
        v9 = (128 - sub_02002D7C(0, v1, 0)) / 2;
        sub_0201D78C(v0, 0, v1, v9, 16 * v8, (0xff), (((u32)(((15 & (0xff)) << 16) | ((13 & (0xff)) << 8) | ((0 & (0xff)) << 0)))), NULL);
    }
...
static void ov62_02239BD8(UnkStruct_0208C06C *param0) {
    ...
    for (v3 = 0; v3 < 9u; v3++) {
        v1 = &v2->unk_D0[v3];
        v5 = Unk_ov62_022491F0[v3].val1.unk_02 / 8;
        v6 = Unk_ov62_022491F0[v3].val1.unk_00 / 8;
        v7 = Unk_ov62_022491F0[v3].val1.unk_03 / 8 - v5;
        v8 = Unk_ov62_022491F0[v3].val1.unk_01 / 8 - v6;
        sub_0201A7A0(v1);
        ...
        if (ov62_02239984(param0, v3) == 1) {
            sub_0201D78C(v1, 0, v0, v9, v10, (0xff), (((u32)(((15 & (0xff)) << 16) | ((13 & (0xff)) << 8) | ((0 & (0xff)) << 0)))), NULL);
        } else {
            sub_0201D78C(v1, 0, v0, v9, v10, (0xff), ((u32)(((12 & (0xff)) << 16) | ((11 & (0xff)) << 8) | ((0 & (0xff)) << 0))), NULL);
        }
